...
//
// Description: Wait for ADC core to be ON and start the interrupt process
//
...
// Function name: itoa
//
// Description: This function converts int to ascii
//
// Passed : val - interge value to be converteded to ascii
// Locals: no variables declared
// Returned: Ascii value of val
// Globals: none
//
// Author: OPEN SOURCE
// Date: Oct 2013
...
//
// Description: Switches the IR LED State based on sample
//
// Passed : no variables passed
// Locals: no variables declared
// Returned: no values returned
...
//=========================================================================== 
// Function name: black_line_detect
//
// Description: This function detects if the sensor values are over a treshold and sets the black_space variable
//
// Passed : no variables passed
// Locals: no variables declared
// Returned: no values returned
...
//=========================================================================== 
// Function name: IR_Calibration
//
// Description: This function does the IR calibration
//
// Passed : state
// Locals: no variables declared
// Returned: no values returned
...
//=========================================================================== 
// Function name: set_treshold
//
// Description: This function calculates the right treshold
//
// Passed : no variables passed
// Locals: no variables declared
// Returned: no values returned
